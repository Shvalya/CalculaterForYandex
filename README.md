...
чтобы запустить калькулятор, нужно открыть терминал, перейти в папку c папку в которую был сохранён проект и в терминале и ввести команду <script>go run main.go</script>
